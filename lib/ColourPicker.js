...
(function() {
  ...
  ColourPicker = (function() {
    ...
    ColourPicker.prototype.build = function() {
      this.buildSpectrum();
      this.buildPicker();
      new MouseHandlerSpectrum(this._ctxObjects.spectrum, this);
      return new MouseHandlerPicker(this._ctxObjects.picker, this);
    };
    ...
    */
    ...
    ColourPicker.prototype._createCTXObject = function(key, canvasElement) {
      ...
      canvas = $('#colour-picker').append(function() {
        return $(document.createElement('canvas')).attr('id', canvasElement).attr('width', _this._plugin.options.elementProperties[canvasElement][0]).attr('height', _this._plugin.options.elementProperties[canvasElement][1]);
      });
