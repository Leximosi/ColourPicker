...
(function() {
  var ColourCalculatorHSV, ColourCalculatorRGB, ColourPicker, MouseHandler, MouseHandlerPicker, MouseHandlerSpectrum,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  window.ColourCalculator = (function() {
    ...
    ColourCalculator.prototype._calculateHEX = function() {
      var rgb;
      rgb = this.getRGB();
      return this.hex = '#' + ("0" + parseInt(rgb[0], 10).toString(16)).slice(-2) + ("0" + parseInt(rgb[1], 10).toString(16)).slice(-2) + ("0" + parseInt(rgb[2], 10).toString(16)).slice(-2);
    };
  ...
  ColourPicker = (function() {
    ...
    ColourPicker.prototype.buildPicker = function() {
      var col, ctx, h, height, i, picker, rgb, row, s, v, width, _h, _s, _v;
      if (typeof this._ctxObjects.picker === 'undefined') {
    ...
    ColourPicker.prototype.buildSpectrum = function() {
      var ctx, currentSpectrumPosition, gradient, height, hue, i, position, positions, rgb, spectrumPosLeft, spectrumWidth, width, _i, _j, _len;
      if (typeof this._ctxObjects.spectrum === 'undefined') {
    ...
    */
    ...
    ColourPicker.prototype._createCTXObject = function(key, canvasElement) {
      ...
      return this._ctxObjects[key]['context'] = this._ctxObjects[key]['canvas'][0].getContext('2d');
    };
