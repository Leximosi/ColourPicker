  ...
  ColourPicker = (function() {
    ...
    */
    ...
    ColourPicker.prototype.buildPicker = function(xPos, yPos) {
      var b, col, crosshair, ctx, g, h, height, i, picker, r, rgb, row, s, v, width, _ref;
      ...
      while (row < height) {
        ...
        _ref = this._HSVtoRGB(h, s, v), r = _ref[0], g = _ref[1], b = _ref[2];
    ...
    */
    ...
    ColourPicker.prototype.buildSpectrum = function() {
      var b, ctx, g, gradient, height, hue, i, r, rgb, spectrumPosLeft, spectrumWidth, width, _i, _ref;
      ...
      for (hue = _i = 0; _i <= 360; hue = _i += 60) {
        _ref = this._HSVtoRGB(hue, 100, 100), r = _ref[0], g = _ref[1], b = _ref[2];
        rgb = "rgb(" + r + ", " + g + ", " + b + ")";
    ...
    */
    ...
    ColourPicker.prototype._dumpCurrentData = function() {
      var b, g, r, _ref,
        _this = this;
      _ref = this._currentToRGB(), r = _ref[0], g = _ref[1], b = _ref[2];
