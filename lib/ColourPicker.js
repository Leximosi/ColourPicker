...
(function() {
  ...
  MouseHandlerPicker = (function(_super) {
    ...
    MouseHandlerPicker.prototype.mouseAction = function(e) {
      var ele, offset, sat, val, xPos, yPos;
      ele = $(this.element);
      offset = ele.offset();
      ...
      if (this.colourPicker._plugin.options.callback.call != null) {
        return this.colourPicker._plugin.options.callback.call();
      }
    };
